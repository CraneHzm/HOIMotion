...
def main(opt):
    ...
    train_dataset = adt_dataset.adt_dataset(data_dir, input_n, output_n, actions, 1, sample_rate)
    ...
    valid_dataset = adt_dataset.adt_dataset(data_dir, input_n, output_n, actions, 0)
...
def eval(opt):
    ...
    test_dataset = adt_dataset.adt_dataset(data_dir, input_n, output_n, actions, 0)
