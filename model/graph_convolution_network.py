...
class graph_convolution_network(nn.Module):
    def __init__(self, in_features, latent_features, node_n=21, seq_len=40, p_dropout=0.3, residual_gcns_num=1):
        ...
        self.end_gcn = graph_convolution(in_features=latent_features, out_features=in_features, node_n=node_n, seq_len=seq_len)
...
class graph_convolution_network_encoder(nn.Module):
    def __init__(self, in_features, latent_features, node_n=21, seq_len=40, p_dropout=0.3, residual_gcns_num=1):
        super(graph_convolution_network_encoder, self).__init__()
        self.residual_gcns_num = residual_gcns_num
        self.seq_len = seq_len
...
class graph_convolution_network_decoder(nn.Module):
    def __init__(self, out_features, latent_features, node_n=21, seq_len=40, p_dropout=0.3, residual_gcns_num=1):
        super(graph_convolution_network_decoder, self).__init__()
        self.residual_gcns_num = residual_gcns_num
        self.seq_len = seq_len
        ...
        self.end_gcn = graph_convolution(in_features=latent_features, out_features=out_features, node_n=node_n, seq_len=seq_len)
